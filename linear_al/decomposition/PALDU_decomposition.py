...
def PALDU_decomposition(A):
    ...
    for now_focus_pivot in range(A_col_len-1):
        ...
        L[:, [max_row_index, now_focus_pivot]] = L[:, [now_focus_pivot, max_row_index]] # col
        L[[max_row_index,now_focus_pivot ], :] = L[[now_focus_pivot, max_row_index], :] # row
        ...
        for row_cursor in range(now_focus_pivot+1, A_row_len):
            ...
            # L[row_cursor, :] = L[row_cursor, :] + eliminator * L[now_focus_pivot, :]
